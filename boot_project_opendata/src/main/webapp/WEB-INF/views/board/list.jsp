  ...
  <div class="promo" role="note" aria-label="프로모션">
    <div class="promo-content">
      <div class="promo-nav">
        ...
        <a href="/board/list" class="nav-board active">게시판</a>
  ...
  <section class="board-section">
    <div class="board-container">
                 ...
                 <c:otherwise>
                   <c:forEach var="board" items="${list}">
                     <tr>
                       ...
                       <td>
                         <!-- 상세: 조회수 +1은 컨트롤러에서 처리 -->
                         <a href="${pageContext.request.contextPath}/board/detail?boardNo=${board.boardNo}">
     ...
     <div class="board-search">
             <form method="get" action="${pageContext.request.contextPath}/board/list" id="searchForm">
